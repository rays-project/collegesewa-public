...
const Header = () => {
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu" aria-labelledby="btechDropdown">
  ...
  <div className="dropdown-menu p-3 mega-dropdown" aria-labelledby="universityDropdown">
 ...
 <li className="nav-item dropdown">
  ...
  <div className="dropdown-menu p-3 mega-dropdown" aria-labelledby="examsDropdown">
    <table className="table table-borderless m-0">
      <thead>
        <tr>
          <th>Categories</th>
...
<li className="nav-item dropdown">
  ...
  <div className="dropdown-menu p-3 mega-dropdown" aria-labelledby="programsDropdown">
    <table className="table table-borderless m-0">
      <thead>
        <tr>
          <th>Course Level</th>
...
<li className="nav-item dropdown">
  ...
  <div className="dropdown-menu p-3 mega-dropdown" aria-labelledby="moreDropdown">
    <table className="table table-borderless m-0">
      <thead>
        <tr>
          <th>Resources</th>
 ...
 <li className="nav-item">
          ...
          <form className="d-flex">
            <Link to='/login' className="btn1 btn-login">Login</Link>
